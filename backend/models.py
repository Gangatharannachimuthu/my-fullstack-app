...
class Member(Base):
    ...
    monthly_sandha_amount = Column(Numeric(12, 2), default=1000)
...
class Loan(Base):
    ...
    outstanding_principal = Column(Numeric(12, 2))
    outstanding_interest = Column(Numeric(12, 2), default=0)
    created_at = Column(DateTime, default=datetime.utcnow)
...
class Settings(Base):
    ...
    id = Column(Integer, primary_key=True)
    default_sandha = Column(Numeric(12, 2), default=1000)
